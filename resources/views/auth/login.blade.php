        ...
        <div class="login-card">
            ...
            <ul class="nav nav-tabs" id="loginTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="nip-tab" data-bs-toggle="tab" data-bs-target="#nip"
                        type="button" role="tab">NIP</button>
                </li>
                <li class="nav-item" role="presentation">
                    ...
                    <form action="{{ route('nip-login') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nip" class="form-control @error('nip') is-invalid @enderror"
                                id="nip" value="{{ old('nip') }}" placeholder="Masukkan NIP">
                            @error('nip')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password"
                                class="form-control @error('password') is-invalid @enderror" id="nip_password"
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="remember_nip"
                                    style="font-size: 0.85rem; color: var(--text-2);">Ingat saya</label>
                            </div>
                        </div>
