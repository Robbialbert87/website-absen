                ...
                <div class="card-body">
                    <form action="{{ route('ruangan.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kode_ruangan" class="form-control @error('kode_ruangan') is-invalid @enderror" value="{{ old('kode_ruangan') }}" placeholder="Contoh: UGD" required>
                            @error('kode_ruangan')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_ruangan" class="form-control @error('nama_ruangan') is-invalid @enderror" value="{{ old('nama_ruangan') }}" placeholder="Contoh: Unit Gawat Darurat" required>
                            @error('nama_ruangan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
